...
impl Default for TamagotchiFactory {
    ...
    pub fn create_tamagotchi(&self, name: String, owner: ActorId) -> Tamagotchi {
        ...
        Tamagotchi {
            ...
            // Asegúrate de que estos campos coincidan con los definidos en la estructura Tamagotchi
            date_of_birth: 0, // Ejemplo, necesitarás una lógica adecuada para esto
            fed: 0,
            fed_block: 0,
            entertained: 0,
            entertained_block: 0,
            ...
            ft_contract_id: ActorId::zero(), // Ejemplo, necesitarás establecer esto adecuadamente
            transaction_id: 0,
